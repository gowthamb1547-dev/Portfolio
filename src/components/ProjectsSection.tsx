...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    { id: 3, title: "Data Visualization Platform", description: "Interactive dashboard for complex data visualization with customizable charts and real-time updates.", image: project3, technologies: ["Python", "Django", "D3.js", "PostgreSQL"], liveUrl: "https://example.com", githubUrl: "https://github.com/example", category: "Data Science" },
